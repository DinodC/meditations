quotes_list = [
    ...
    """,
    """
    Operatics, combat and confusion. Sloth and servility. Every day they blot
    out those sacred principles of yours - which you daydream thoughtlessly
    ...
    * at maintaining a confidence founded on understanding. An unobtrusive
    ...
    """,
    """
    Nature gives and nature takes away. Anyone with sense and humility will tell
    her, "Give and take as you please," not out of defiance, but out of
    obedience and goodwill.
    """,
    """
    ...
    """,
    """
    Stop whatever you're doing for a moment and ask yourself: Am I afraid of
    death because I won't be able to do this anymore?
    """,
    """
    When faced with people's bad behavior, turn around and ask when you have
    acted like that.
    """,
    """
    The raw material you're missing, the opportunities...! What is any of this
    but training - training for your logos, in life observed accurately,
    scientifically.
    """,
    """
